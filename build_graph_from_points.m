function graph = build_graph_from_points(points, offset, k, dist_cap,edge_weight_mode,dist_type)
...
graph.source      = int32(edges_coord(:,1)+offset);
graph.target      = int32(edges_coord(:,2)+offset);
